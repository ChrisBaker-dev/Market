...
## Functionality / Features
 ...
 - View Listings is the home page for farmers marketplace. It displays all relevant listings to the user and allows for navigation to other features within the marketplace.
...
1. As a user, I want to be able to make purchases within the application.

2. As a user, I want to be able to message sellers in order to enquire about their listings.

3. As a user, I want to be able to post produce to sell

4. As a user, I want to be able to login so other.

5. As a user, I want to be able to create a profile in order to have my listings, purchases and relevant data tracked.

6. As a user, I want to be able to manage a profile so I may update my information as it changes.

7. As an Administrator, I want to be able to delete postings that may conflict with terms of service.
...
This application uses several third party applications including:
...
This application made use of a Trello board in order to track user stories, features and tasks to be completed. The Trello board is broken up into x columns, 